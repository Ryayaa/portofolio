...
const AnimatedContent = ({
  ...
  useEffect(() => {
    ...
    // Logic: reverse true berarti datang dari arah berlawanan (misal -100), 
    // reverse false berarti datang dari arah positif (100).
    ...
    // Animation to target state (0, scale 1, opacity 1)
    tl.to(el, {
      [axis]: 0,
      scale: 1,
      opacity: 1,
    ...
    const st = ScrollTrigger.create({
      ...
      start: `top ${startPct}%`, // Memicu saat elemen mencapai persentase viewport tertentu
      once: true,
      onEnter: () => tl.play()
    });
